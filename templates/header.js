...
const NAV_ITEMS = [
...

  {
    ...
    children: [
      {
        label: 'Kestirme Fırçalar',
        subLabel: 'Kestirme Fırçaları',
        href: '/kestirme'
      },
      {
        label: 'Akrobat Fırçalar',
        subLabel: 'Akrobat Fırçaları ',
        href: '/akrobat'
      },
      {
        label: 'Master Fırçalar',
        subLabel: 'Master Fırçaları ',
        href: '/master'
      },
      {
        label: 'Akrilik Fırçalar',
        subLabel: 'Akrilik Fırçaları ',
        href: '/akrilik'
      }
      ,
      {
        label: 'Yağlı Boya Fırçalar',
        subLabel: 'Yağlı Boya Fırçaları ',
        href: '/yagliboya'
      }
    ]
  },
